...
function tableStart(start, end) { // функція яка вставляє години погоди
    ...
    for (let i = start; i < end; i++) {
        ...
        if (start === 0 ) {
            ...
            temp.insertAdjacentHTML("beforeend", `<td class="td_today">${resultTemp}°</td>`)
            feels__like.insertAdjacentHTML("beforeend", `<td class="feels__like_today">${resultTempFeels} °C</td>`)
            temp__min.insertAdjacentHTML("beforeend", `<td class="td_today">${resultTempMin}°</td>`)
            temp__max.insertAdjacentHTML("beforeend", `<td class="td_today">${resultTempMax}°</td>`)
            ...
            temp.insertAdjacentHTML("beforeend", `<td>${resultTemp}°</td>`)
            feels__like.insertAdjacentHTML("beforeend", `<td>${resultTempFeels}°</td>`)
            temp__min.insertAdjacentHTML("beforeend", `<td>${resultTempMin}°</td>`)
            temp__max.insertAdjacentHTML("beforeend", `<td>${resultTempMax}°</td>`)
